...
public class ScheduleRecyclerAdapter extends RecyclerView.Adapter<com.youdo.ScheduleRecyclerAdapter.CalendarViewHolder> {
        ...
        @Override
        public com.youdo.ScheduleRecyclerAdapter.CalendarViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            // inflating recycler item view
            View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.schedule_row,parent,false);

            return new com.youdo.ScheduleRecyclerAdapter.CalendarViewHolder(itemView);
        }

        //This methods applys the data to the view
        @Override
        public void onBindViewHolder(final com.youdo.ScheduleRecyclerAdapter.CalendarViewHolder holder, int position) {
